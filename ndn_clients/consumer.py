...
async def main():
    try:
        content = await send_interest(app, '/function1/xxaaa/(/producer1/aaa, /producer1/bbb)')
        # content = await send_interest(app, '/function1/xxaaa/(/producer1/aaa)')
        # content = await send_interest(app, '/producer2/aaa')
